...
export const articlesData: Article[] = [
  {
    ...
    date: '20/06/2025',
    title: 'iCAM ONLINE KHỞI ĐỘNG TRẠI HÈ STEMVERSE CAMP 2025 – KHƠI NGUỒN SÁNG TẠO, XÂY NỀN LÃNH ĐẠO TÀI NÃNG!',
    url: '/news',
    ...
    content: 'Trại hè STEMVERSE CAMP 2025 do iCAM Online tổ chức mở ra không gian trải nghiệm công nghệ đa chiều, nơi các em học sinh được trực tiếp chế tạo mô hình, ứng dụng tiếng Anh thực tiễn và rèn luyện kỹ năng làm việc nhóm. Chương trình được thiết kế kết hợp phương pháp 4Ls và LETI giúp học viên tự tin thể hiện bản thân.',
  ...
  },
  {
    ...
    date: '15/05/2025',
    title: '[iCAM Online] Global Arena - Đấu Trường Vinh Quang',
    url: '/news',
    excerpt: 'Global Arena - Đấu Trường Vinh Quang là sự kiện đặc biệt được iCAM Online tổ chức hằng năm, nơi học sinh thử thách bản thân và bứt phá giới hạn.',
  ...
  },
  {
    ...
    date: '10/05/2025',
    title: '200 "NHÀ KHOA HỌC NHÍ" TỎA SÁNG TẠI CHUNG KẾT BIỆT ĐỘI KHOA HỌC iCAM',
    url: '/news',
    ...
    content: 'Vòng chung kết Biệt Đội Khoa Học iCAM diễn ra vô cùng sôi nổi với các phần thi thuyết trình đề tài khoa học bằng 100% tiếng Anh. Học sinh thể hiện xuất sắc tư duy phản biện và khả năng ứng dụng tri thức vào giải quyết bài toán thực tế.',
    image: placeholderImg,
  },
  {
    id: 4,
    ...
    date: '28/04/2025',
    title: '[iCAM Online] CÔNG BỐ DANH SÁCH HỌC SINH NHẬN HỌC BỔNG TOÁN VÀ KHOA HỌC',
    url: '/news',
    excerpt: 'Ban Tổ Chức rất vui mừng công bố danh sách các thí sinh xuất sắc nhất đã nhận được Học Bổng Tài Năng Toán & Khoa Học iCAM Online.',
    content: 'Trải qua các vòng thi đánh giá năng lực toàn diện, Ban Tổ Chức iCAM Online đã chọn lựa ra những học viên có thành tích xuất sắc nhất để trao tặng các suất học bổng giá trị. Học bổng hướng tới việc nuôi dưỡng niềm đam mê tự học và khai phóng tiềm năng của học sinh.',
    image: placeholderImg,
  },
  {
    id: 5,
    ...
    date: '15/04/2025',
    title: '[iCAM Online] ĐẤU TRƯỜNG TOÁN VÀ KHOA HỌC - MATH & SCIENCE ARENA',
    url: '/news',
  ...
  },
  {
    ...
    content: 'Để trẻ tự tin làm chủ ngôn ngữ, điều quan trọng là xây dựng môi trường học không rập khuôn hay ép buộc ghi nhớ thụ động. Phương pháp tương tác LETI của iCAM giúp trẻ chủ động thảo luận, ứng dụng bài học và liên tục nâng cao sự tự tin.',
    image: newsLimit,
  },
  {
    id: 8,
    ...
    content: 'Trang bị tiếng Anh song hành cùng tư duy công nghệ số mang lại lợi thế lớn cho thế hệ trẻ. Sự kết hợp giữa mô hình 4Ls và công nghệ giáo dục hiện đại tạo tiền đèo cho học sinh tự học bền vững.',
    image: placeholderImg,
  },
  {
    id: 9,
